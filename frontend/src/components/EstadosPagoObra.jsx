...
export default function EstadosPagoObra({ user, obraNombre, obra }) {
  ...
  return <div className="space-y-5 animate-in fade-in duration-200">
    ...
    <div className="grid items-start gap-4 xl:grid-cols-[430px_minmax(0,1fr)]">
      ...
      {estados.length > 0 && <DocumentAuditTrail records={estados.flatMap(item => Array.isArray(item.trazabilidad) ? item.trazabilidad : [])} title="Registro de firmas y acciones de los Estados de Pago" />}
