...
function FacturacionLegacy({ user, companyBranding, onBack }) {
  ...
  const [showFactEmailModal, setShowFactEmailModal] = useState(false);
  ...
  return (
    <ErrorBoundary>
      ...
      <div className="flex overflow-x-auto bg-slate-100 p-1.5 rounded-2xl gap-1 border border-slate-200 select-none">
        {isSubmenuEnabled('facturacion_emitidos') && (
          <button
        ...
        {isSubmenuEnabled('facturacion_clientes') && (
          <button
        ...
        {canConfigureEmails(user) && (
          <button
            type="button"
            onClick={() => setShowFactEmailModal(true)}
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-bold rounded-xl transition cursor-pointer shrink-0 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300"
            title="Configurar destinatarios de notificaciones de facturación por correo"
          >
        ...
        {isSubmenuEnabled('facturacion_configuracion') && (
          <button
      ...
      {/* Modal Contextual de Correos de Facturación */}
      <ContextualEmailConfigModal
        isOpen={showFactEmailModal}
        onClose={() => setShowFactEmailModal(false)}
        moduloTitle="Configurar Correos de Facturación y DTEs"
        moduloKey="facturacion_dtes"
        user={user}
      />
