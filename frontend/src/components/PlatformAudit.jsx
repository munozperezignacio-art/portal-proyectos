  ...
  return <div className="space-y-4">
    ...
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-6">
        ...
        <select value={filters.resultado} onChange={e => { setPage(0); setFilters(v => ({...v, resultado:e.target.value})); }} className="h-10 rounded-xl border border-slate-200 px-3 text-xs font-bold"><option value="">Todos los resultados</option><option value="exitoso">Exitosos</option><option value="fallido">Fallidos</option><option value="observado">Observados</option><option value="pendiente">Pendientes</option></select>
