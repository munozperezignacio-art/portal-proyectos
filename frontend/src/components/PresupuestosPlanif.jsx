...
export default function PresupuestosPlanif({ user, companyBranding, onBack }) {
  ...
  const [showPresupEmailModal, setShowPresupEmailModal] = useState(false);
...
IMPORTANTE: Retorna ÚNICAMENTE el objeto JSON válido. No rodees el resultado con bloques de código markdown de tipo \`\`\`json o similar, ni agregues ningún texto explicativo. Solo el objeto JSON.`;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-white p-6 border border-slate-200 rounded-3xl shadow-xs">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full lg:w-auto">
          ...
          {canConfigureEmails(user) && (
            <button
              type="button"
              onClick={() => setShowPresupEmailModal(true)}
              className="flex items-center justify-center gap-1.5 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold px-3.5 py-2.5 rounded-xl border border-slate-300 transition cursor-pointer shadow-xs"
              title="Configurar destinatarios de notificaciones por correo para presupuestos"
            >
          ...
          <>
            ...
            {activeSection === '' ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {isSubmenuEnabled('presupuestos_items') && (
                  <div 
                ...
                {isSubmenuEnabled('presupuestos_cronograma') && (
                  <div 
                ...
                {/* Card 5: Recursos */}
                {isSubmenuEnabled('presupuestos_recursos') && (
                  <div 
                ...
                {isSubmenuEnabled('presupuestos_indirectos') && (
                  <div 
      ...
      {/* Modal Contextual de Correos de Presupuestos */}
      <ContextualEmailConfigModal
        isOpen={showPresupEmailModal}
        onClose={() => setShowPresupEmailModal(false)}
        moduloTitle="Configurar Correos de Presupuestos y Planificación"
        moduloKey="presupuestos_planificacion"
        user={user}
      />
