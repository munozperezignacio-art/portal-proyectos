...
export function buildExecutiveReportHtml({ schedule, company, selected, advances, attendance, costs, nonConformities, prevention, parts, periodDays = 7 }) {
  ...
  return { html, indicators:{ obras:selected.length, reportes:totalReports, bac, pv, ev, ac, spi, cpi, sv, cv, eac, dias_desviacion:scheduleVarianceDays, nc_abiertas:totalNc }, cards };
}
