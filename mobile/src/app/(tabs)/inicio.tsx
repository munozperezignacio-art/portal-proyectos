...
export default function Home() {
  ...
  return <Screen>
    <Header title={`Hola, ${profile?.nombre || profile?.usuario}`} subtitle={`${profile?.empresa} · ${profile?.cargo || profile?.rol || 'Usuario'}`} icon="grid-outline" action={<Pressable onPress={() => setMenu(true)} style={s.menuButton}><Ionicons name="menu" size={23} color={colors.ink}/></Pressable>}/>
