...
CREATE TABLE IF NOT EXISTS public.clientes_portal_obras (
  ...
  portal_id UUID NOT NULL REFERENCES public.clientes_portales(id) ON DELETE CASCADE,
  empresa TEXT NOT NULL,
  obra_nombre TEXT NOT NULL,
  permisos JSONB NOT NULL DEFAULT '{}'::jsonb,
  permite_comentar BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS public.clientes_portal_eventos (
  id BIGSERIAL PRIMARY KEY,
  portal_id UUID REFERENCES public.clientes_portales(id) ON DELETE CASCADE,
  empresa TEXT NOT NULL,
  obra_nombre TEXT,
